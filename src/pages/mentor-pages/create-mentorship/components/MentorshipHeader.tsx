...
export const MentorshipHeader: FC<Props> = ({ onBack }) => (
    <div className="flex flex-col gap-1 mb-6 sm:mb-8">
        ...
        <div className="flex items-center cursor-pointer a"
          onClick={onBack}
          >
            {/* Back Button Wrapper - Enhanced for better UX */}
            <button 
              
                className="inline-flex items-center justify-center px-1.5 -ml-1.5 rounded-full hover:bg-gray-100 text-gray-600 hover:text-gray-900 transition-all active:scale-95"
                aria-label="Go back"
            >
