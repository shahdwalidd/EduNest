...
const ServicesSection: React.FC = memo(() => {
  return (
    // تم حذف lg:max-h-[700px] لمنع تداخل السكاشن عمودياً واعتمدنا على الطول المرن التلقائي
    <section className="py-12 bg-[var(--primary-from)] dark:bg-gray-900 text-white max-h-full">
      ...
      <div className="max-w-7xl mx-auto px-6 xl:px-16">
        ...
        {/* تم تغيير نقطة انقسام العمودين إلى xl لحماية الكروت من الانضغاط والتداخل في الشاشات المتوسطة */}
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 xl:gap-20">
          
          {/* Mentors column */}
          <div>
            {/* الديف الأصلي كما هو تماماً بدون أي تعديل */}
