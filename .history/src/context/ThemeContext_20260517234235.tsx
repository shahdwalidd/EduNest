...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // i stoped using `dark` class and switched to `light` for dark mode to avoid conflicts with tailwind's dark mode class and to have more control over the styles.
