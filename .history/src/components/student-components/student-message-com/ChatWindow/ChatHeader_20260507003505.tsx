      ...
      <div className="flex-1 min-w-0">
        ...
        {isGroup ? (
          ...
          <div className="flex items-center flex-wrap gap-2">
            <span className="text-xs text-[#4CAF50] font-medium">Online</span>
            {chat.unreadCount && chat.unreadCount > 0 && (
              <span className="inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-red-500 text-[10px] font-semibold text-white">
                {chat.unreadCount > 99 ? '99+' : chat.unreadCount} unread
              </span>
            )}
          </div>
        )}
