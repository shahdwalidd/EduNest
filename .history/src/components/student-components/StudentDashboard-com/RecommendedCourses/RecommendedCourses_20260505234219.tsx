...
const RecommendedCourseCard: FC<RecommendedCourseCardProps> = ({ course, onAddToCart }) => {
  ...
  return (
    <div className="flex justify-center w-full">
      <Link to={`/student/learning/${course.id}`} className="group bg-white rounded-2xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 w-full max-w-lg">
