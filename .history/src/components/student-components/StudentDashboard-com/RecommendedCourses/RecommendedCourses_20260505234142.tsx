...
const RecommendedCourseCard: FC<RecommendedCourseCardProps> = ({ course, onAddToCart, onViewDetails }) => {
  ...
  return (
    <div className="flex justify-center w-full">
      <div 
        className="group bg-white rounded-2xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 w-full max-w-lg cursor-pointer" 
