...
import { BookOpen, BotIcon, CalendarDays, ChevronDown, FileText, PlayCircle } from 'lucide-react';
  ...
  return (
    <aside className="w-full lg:w-[350px] flex-shrink-0">
      <div className="lg:sticky lg:top-24 space-y-4">
        <div className=" flex bg-white rounded-3xl border border-gray-200 p-5 shadow-sm">
