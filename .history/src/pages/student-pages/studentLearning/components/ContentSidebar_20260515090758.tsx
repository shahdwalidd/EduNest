  ...
  return (
    <aside className="w-full lg:w-[350px] flex-shrink-0">
      ...
      <Link
        ...
        className="m-[70px] text-white px-4 py-2.5 mt-4 text-center text-sm rounded-full bg-[var(--primary-500)] hover:bg-[var(--primary-600)] transition-colors duration-200 block"
      >
