...
const QuizPlayer = ({ quizId, onBack, isCompleted }: QuizPlayerProps) => {
  ...
  const currentQuestion = (questions as QuizQuestion[] | undefined)?.[currentQuestionIndex];
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl mb-8 max-w-4xl mx-auto max-h-[400px] overflow-y-auto">
              ...
              <div className="space-y-3">
                {(['A', 'B', 'C', 'D'] as const).map((option) => {
                  ...
                  const optionText = (currentQuestion as QuizQuestion)?.[optionKey];
                  ...
                  return (
                    <button
                      ...
                      className={`
                        w-full p-4 rounded-xl border-2 transition-all duration-200 flex items-center gap-3 text-left hover:shadow-md hover:-translate-y-0.5
                        ${isSelected 
                          ? 'border-[var(--primary-500)] bg-[var(--primary-500)]/10 shadow-lg ring-2 ring-[var(--primary-500)]/30 font-semibold' 
