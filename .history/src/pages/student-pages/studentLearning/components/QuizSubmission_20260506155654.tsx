...
import { getQuizDetails, getQuizQuestions, submitQuizAnswers } from '../../../../services/student-roleService/';
    ...
    return (
      <div className="bg-white rounded-3xl p-6 shadow-lg">
        <div className="text-center py-8">
          ...
          {score && <p className="text-lg text-slate-600">Your Score: {score}</p>}
      ...
      <div className="bg-white rounded-3xl p-6 shadow-lg">
        <div className="text-center py-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-[var(--primary-500)] text-white px-6 py-3 rounded-lg hover:bg-[var(--primary-600)] transition-colors"
          >
      ...
      {isReviewMode ? (
        ...
        <>
          ...
          <div className="flex justify-between">
            ...
            <button
              onClick={handleNext}
              className="inline-flex items-center gap-2 bg-[var(--primary-500)] text-white px-6 py-2 rounded-lg hover:bg-[var(--primary-600)] transition-colors"
            >
