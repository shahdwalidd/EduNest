...
import type { Week, WeekContent, ContentItem } from '../../../types/student-role-types/studentMentorshipTypes';
...
const StudentMentorshipContent = () => {
  ...
  const weekQuery = isWeekView ? useWeekContent(normalizedWeekId!) : null;
  
  const data = isWeekView ? weekQuery?.data : mentorshipQuery.data;
  const isLoading = isWeekView ? weekQuery?.isLoading : mentorshipQuery.isLoading;
  const error = isWeekView ? weekQuery?.error : mentorshipQuery.error;
