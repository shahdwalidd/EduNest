  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          {/* HEADER */}
          <div className="sticky top-0 z-10 px-5 py-4 border-b border-white/10 bg-slate-900/90 backdrop-blur-xl">
            ...
            <div className="mt-3 relative">
              ...
              <input
                ...
                className="
                  ...
                  outline-none focus:border-indigo-500/40
          ...
          <div className="p-4 overflow-y-auto space-y-3">
            ...
            {isLoading &&
              Array.from({ length: 4 }).map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse flex items-center gap-4 p-3 bg-white/5 rounded-xl"
                >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs mt-1 text-slate-400 flex items-center gap-1">
                        {room.joined ? (
                          <>
