...
import type { PaginatedUpcomingItems, UpcomingItem } from '../../../../types/student-role-types/studentMentorshipTypes';
...
const UpcomingItemsSection: FC<UpcomingItemsSectionProps> = ({ upcomingItems }) => {
  if (!upcomingItems?.content || upcomingItems.content.length === 0) return null;
  ...
  return (
    <section className="bg-white rounded-2xl shadow-sm p-8">
      ...
      <div className="space-y-4">
        {upcomingItems.content.map((item: UpcomingItem) => {
...
<parameter name="path">src/pages/student-pages/mentorshipDetails/StudentMentorshipDetails.tsx
