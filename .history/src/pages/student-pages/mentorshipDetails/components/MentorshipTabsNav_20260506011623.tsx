...
const MentorshipTabsNav: FC = () => {
  return (
    <nav className="border-b border-gray-200 bg-white sticky rounded-2xl top-0 z-20 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="-mb-px flex space-x-8  overflow-x-auto md:justify-center lg:justify-start">
          {tabs.map((tab) => (
            <NavLink
              key={tab.id}
              to={tab.to}
